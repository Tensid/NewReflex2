...
namespace Reflex.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        //public UsersController(ILogger<UsersController> logger, IUserUtils userUtils, IRepository repository, UserManager<ApplicationUser> userManager)
        public UsersController(ILogger<UsersController> logger, IUserUtils userUtils, IRepository repository)
        {
            _logger = logger;
        ...
        //    var currentUser = _userUtils.CurrentUser;
