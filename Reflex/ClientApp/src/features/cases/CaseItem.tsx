  ...
  return (
    <div className="row align-items-center">
      <div className="col-lg-12">
        <button disabled={unavailableDueToSecrecy} className={`btn btn-block btn-outline-${color} justify-content-start mb-1 ${styles.blackOutline} ${styles.btn}`} onClick={handleClick}>
