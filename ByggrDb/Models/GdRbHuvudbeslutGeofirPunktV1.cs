namespace ByggrDb
{
    public partial class GdRbHuvudbeslutGeofirPunktV1
    {
        ...
        public DateTime Beslutdatum { get; set; }
        public string? Beslutnr { get; set; }
        public string? Beslututfallkod { get; set; }
        public string? Beslututfall { get; set; }
        public DateTime? Beslutgiltigtilldatum { get; set; }
        public bool Beslutinstansardelegat { get; set; }
        public string Beslutinstanskod { get; set; } = null!;
        public string Beslutinstans { get; set; } = null!;
        public bool? Beslutarmindreavvikelse { get; set; }
    }
}