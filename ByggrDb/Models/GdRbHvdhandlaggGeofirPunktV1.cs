namespace ByggrDb
{
    public partial class GdRbHvdhandlaggGeofirPunktV1
    {
        ...
        public string Handlaggaresignatur { get; set; } = null!;
        public string? Handlaggarenamn { get; set; }
        public bool Handlaggarearaktiv { get; set; }
    }
}