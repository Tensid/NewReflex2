namespace ByggrDb
{
    public partial class OvRbArbygGeoV1
    {
        public decimal? RadId { get; set; }
        ...
        public decimal KomBid { get; set; }
        public string Beskrivning { get; set; } = null!;
        public short? Husnr { get; set; }
        public string? Andamal { get; set; }
        public string? Detaljeratandamal { get; set; }
    }
}